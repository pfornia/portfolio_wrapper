...
## Meta (Facebook) | Software Engineer - ML (Sep 2021 - Present)

* Owner of large feature (100M+ daily impressions) that supports
the FB group ecosystem by providing personalized
recommendations of lesser-known groups
* The feature increases the number of FB Groups with sustainable
levels of engagement by hundreds of thousands (my contributions
in 2022H1 increased this effect by 5%)
* Increased click rate by 10%
* Decreased latency by tens of milliseconds
